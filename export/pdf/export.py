...
from export.pdf.constants import (
...
from export.pdf.renderer import _render_table, _compute_widths, _truncate_text
...
def export_to_pdf(output_path, data: PdfReportData):
    ...
    from export.pdf.reports import build_bs_column_names
    ...
    from config.nota import NOTA_GROUPS, numbered_groups, nota_title as _nota_title, RenderPattern, build_partida_nota_map
    _attr_label_cols = {
