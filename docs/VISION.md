...
### What Is This?
A web-based dashboard that allows non-technical users to view and analyze financial reports (P&L and Balance Sheet) for the Fiberlux group of companies. Users see everything in the browser — monthly breakdowns, revenue details, drill-down into journal entries — and can export the current view to Excel when needed.
...
8. Exports the current view to Excel when a downloadable copy is needed
