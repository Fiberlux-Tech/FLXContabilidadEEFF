...
# Dynamic reclassification: accounts that move between sections when cumulative SALDO is negative
BS_RECLASS_ANTICIPO_CUENTA = "12.2.1.1.01"  # negative -> PASIVO "Anticipos Recibidos"
BS_RECLASS_14_TO_PASIVO = "14"               # prefix 14 negative -> PASIVO "Provisiones por beneficios a empleados"
BS_RECLASS_42_2_TO_ACTIVO = "42.2"           # prefix 42.2 negative -> ACTIVO "Anticipos Otorgados"
