...
from account_rules import PL_SUBTOTAL_LABELS, BS_SUBTOTAL_LABELS, BS_PARTIDA_LABELS
from aggregation import TOTAL_COL
...
def style_two_table_sheet(ws):
    ...
    for row in range(1, ws.max_row + 1):
        ...
        if val in month_abbrevs:
            ...
            # Section title is 2 rows above the header (label_row layout)
            title_row = row - 2
